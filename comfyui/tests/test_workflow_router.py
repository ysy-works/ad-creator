...
from comfyui.orchestrator import UnknownWorkflowError, WorkflowRouterError, build_prompt, submit_prompt
...
class WorkflowRouterTest(unittest.TestCase):
    def test_uses_default_workflow_and_applies_bindings(self):
    ...
    def test_submits_resolved_prompt_to_comfyui(self):
        resolved = build_prompt(values={"source_image": "request.png"})
